...
public class DragDrop : MonoBehaviour, IPointerDownHandler, IBeginDragHandler , IEndDragHandler ,IDragHandler 
{
    ...
    private void Awake()
    {
        ...
        //pos0.texture = Resize(pos0, 200, 100);
    }
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        Debug.Log("currect_img_w_h" + currentImg.GetComponent<RectTransform>().localScale.x + " --- " + currentImg.GetComponent<RectTransform>().localScale.y);
    }
